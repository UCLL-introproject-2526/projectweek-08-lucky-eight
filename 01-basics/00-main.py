...
# ================= GAME =================
def game():
    frog_surface = frogs[selected_frog_index] if selected_frog_index is not None else frogs[0]
    frog_x = WIDTH//2 - 42
    frog_y = HEIGHT//2 - 42
    ...
    while True:
        ...
        screen.blit(frog_surface,(frog_x,frog_y))
        txt = button_font.render("ESC = terug naar menu", True, (200,200,200))
        screen.blit(txt,(WIDTH//2-txt.get_width()//2,frog_y+100))
